...
// Ported verbatim from the original client-side js/constants.js so the backend
// rules and the (former) client logic share identical values.
...
const CARD_ANIMATION_DELAY = 1000; // milliseconds (UI concern; kept for parity)
